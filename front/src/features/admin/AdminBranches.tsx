    ...
    <Layout>
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-neutral-400">Управление офисами компании</p>
        </motion.div>
                ...
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-neutral-400 mb-2">{branch.address}</p>
                      {branch.phone && (
        ...
        {branches.length === 0 && (
          <Card>
            <div className="text-center py-12">
              ...
              <p className="text-neutral-400">Офисы не найдены</p>
            </div>
          </Card>
        )}
